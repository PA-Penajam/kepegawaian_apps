...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('berkas_checklist_submissions', function (Blueprint $table) {
            ...
            $table->foreignUlid('berkas_checklist_template_id')->references('id')->on('berkas_checklist_templates')->restrictOnDelete();
            $table->string('subject_type');
            $table->ulid('subject_id');
            $table->foreignUlid('pegawai_id')->references('id')->on('pegawai')->restrictOnDelete();
