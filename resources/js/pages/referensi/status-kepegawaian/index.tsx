...
export default function Index() {
    const { statusKepegawaian, filters } = usePage<Props>().props;
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-4 p-4">
                ...
                {statusKepegawaian.meta.last_page > 1 && (
                    <Pagination>
                        <PaginationContent>
                            {statusKepegawaian.meta.current_page > 1 && (
                                <PaginationItem>
                                    <PaginationPrevious
                                        href={`?page=${statusKepegawaian.meta.current_page - 1}`}
                                    />
                                </PaginationItem>
                            )}

                            {Array.from(
                                { length: statusKepegawaian.meta.last_page },
                                (_, i) => i + 1,
                            ).map((page) => {
                                if (
                                    page === 1 ||
                            ...
                            {statusKepegawaian.meta.current_page <
                                statusKepegawaian.meta.last_page && (
                                <PaginationItem>
                                    <PaginationNext
                                        href={`?page=${statusKepegawaian.meta.current_page + 1}`}
                                    />
