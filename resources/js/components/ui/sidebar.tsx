  ...
  return (
    ...
    >
      ...
      >
        <div
          data-sidebar="sidebar"
          className="bg-sidebar group-data-[variant=floating]:border-sidebar-border border-r-[3px] border-foreground flex h-full w-full flex-col group-data-[variant=floating]:rounded-xl group-data-[variant=floating]:border-[3px] group-data-[variant=floating]:drop-shadow-[4px_4px_0_rgba(0,0,0,1)]"
        >
          {children}
        </div>
      </div>
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto scroll-smooth scrollbar-none group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
